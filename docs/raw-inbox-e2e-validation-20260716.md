...
> 历史报告（superseded）：其中旧共享 Base 的 `91403`、人工编排和 v0.1 产物结论仅描述 2026-07-16 的实验。2026-07-19 已改用当前账号自有测试 Base，并由 `scripts/feishu_base_worker.py` 完成读取、领取、处理与诚实回写。当前协议以 `oks-connector/schemas/` 为准。
