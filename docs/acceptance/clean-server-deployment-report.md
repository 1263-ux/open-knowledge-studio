...
> 历史验证快照：本报告记录的是 v0.2.x 时代的隔离部署，不是当前 v0.4 发布 Gate。当前 Gate 见 [`v0.4.0-rc1/summary.md`](v0.4.0-rc1/summary.md)。主机、目录、服务名和运行 ID 均已脱敏。
...
无关服务未触碰：`<unrelated service process>`
