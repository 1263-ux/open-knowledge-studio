...
| `oks mail send/reply/inbox/thread/read/archive/count/ack/snapshot/wait` | Agent 间持久协作与交接；协议见 [Mail 协议](mail-protocol.html) |
| `oks mail serve/setup/migrate` | 本机人类 Mail 工作面、库外宿主 portable binding、旧版扁平 inbox 迁移 |
