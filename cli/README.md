...
```bash
pipx install "git+https://github.com/1263-ux/claude-code-knowledge-studios.git@main#subdirectory=cli" && pipx ensurepath   # 1. install the CLI
...
- Source & issues: https://github.com/1263-ux/claude-code-knowledge-studios
