...
> A knowledge engineering workspace for Codex — raw → wiki → recall.

## What is this?

Open Knowledge Studio is a file-based knowledge base system designed for use with Codex. It provides:
...
```
open-knowledge-studio/
├── .Codex/          # Codex skills (8) + hooks (3) + rules (2)
...
- Personal knowledge lives in a separate instance created by `oks init <path>`; this repository remains reusable Studio code.
